                ...
                <div className="sixth-week-outer">
                    ...
                    <div className="sixth-week-text">
                        This week was a roller-coaster. We started this week with a new preassigned group.
                           ...
                           using Socket.io, React and PostgreSQL.</a> This week, we changed groups and
                        ...
                        It took much of the 3 days just understanding this subject. Interpolation helps you predict what a game would look
                            ...
                            instantly to all clients. Because of network latency, clients would experience smooth gameplay only dependent on their connection speed. This would most definitely cause glitchy gameplay.
                            You also can't rely on a past state in the users browser because that also would mean you would have to
                            send that information through the network to other players, which come back again, to the latency problem.
                        ...
                        So now, what do you rely on to predictably display the game correctly on all players screens with no glitches? Time.
                            ...
                            what the game should now look like right now. So rendering takes place based on the interpolation of all the player(s) actions up to the current time.
                            <br />
                        <br />
                        This is a really cool and advanced topic. I learned a lot about state management in a multiplayer game. Once me and my team
                            ...
                            we did manage to get the game working and interpolating on multiple viewers screens with asteroids floating around.
